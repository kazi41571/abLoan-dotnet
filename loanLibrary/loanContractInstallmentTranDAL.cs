    ...
    public class loanContractInstallmentTranDAL
    {
        ...
        private List<loanContractInstallmentTranDAL> SetListPropertiesFromSqlDataReader(SqlDataReader sqlRdr)
        {
            ...
            while (sqlRdr.Read())
            {
                ...
                objContractInstallmentTran.linktoContractStatusMasterId = Convert.ToInt32(sqlRdr["linktoContractStatusMasterId"]);
                ...
                objContractInstallmentTran.ContractStatus = Convert.ToString(sqlRdr["ContractStatus"]);
