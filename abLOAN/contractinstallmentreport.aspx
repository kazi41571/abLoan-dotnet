<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="contractinstallmentreport.aspx.cs"
    Inherits="abLOAN.contractinstallmentreport" %>
        ...
        <div class="blockui">
            <asp:UpdatePanel ID="upcontractinstallment" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="row">
                        <div style="justify-content: space-between; display: flex;">
                            <div style="padding: 0 15px;">
                                <h4>
                                    <i class="fa fa-th"></i>&nbsp;<%= Resources.Resource.ContractInstallmentReportPageTitle %>&nbsp;
                                    <small>
                    ...
                    <asp:ListView ID="lvContractInstallmentTran" runat="server" DataKeyNames="ContractInstallmentTranId" OnItemDataBound="lvContractInstallmentTran_ItemDataBound">
                        <LayoutTemplate>
                            <div class="panel panel-default">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-center">
                            <cc1:DataPager ID="pgrContractInstallmentTran" runat="server" OnPagerCommand="pgrContractInstallmentTran_ItemCommand"
