<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="purchasesalestransactions.aspx.cs" Inherits="abLOAN.purchasesalestransactions" %>
        ...
        <div class="blockui">
            <asp:UpdatePanel ID="uppurchasesalestransactions" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <div class="row">
                        <div style="justify-content: space-between; display: flex;">
                            <div style="padding: 0 15px;">
                                <h4>
                                    <i class="fa fa-th"></i>&nbsp;<%= Resources.Resource.PurchaseSalesTransactionsPageTitle %>&nbsp;
                                    <small>
                                ...
                                <asp:Panel ID="pnlFilter" runat="server" DefaultButton="btnSearch">
                                    <div class="form-horizontal">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4 col-sm-6">
                                                <div class="form-group">
                                                    <label class="col-sm-5 control-label"><%= Resources.Resource.CategoryName %></label>
                                                    <div class="col-sm-7">
                                                        <asp:DropDownList ID="ddlFilterCategory" runat="server" CssClass="form-control input-sm"></asp:DropDownList>
                                                        <%-- <div class="text-danger">
                                                            <asp:RequiredFieldValidator ID="rfvFilterCategory" runat="server"
                                                                ControlToValidate="ddlFilterCategory" Display="Dynamic"
                                                                ValidationGroup="FilterPurchaseSalesTransactionsMaster"><%= Resources.Messages.InputRequired %> <%=Resources.Resource.CategoryName %></asp:RequiredFieldValidator>
                                                        </div>--%>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div style='font-family: Calibri, monospace; font-size: 20px;'>
                        <%= Resources.Resource.OpeningQuantity %> :
                        <asp:Literal ID="ltrlOpeningBalanceTotal" runat="server"></asp:Literal>
                    </div>
                    ...
                    <asp:ListView ID="lvPurchaseSalesTransactionsMaster" runat="server" DataKeyNames="SalesMasterId" OnDataBound="lvPurchaseSalesTransactionsMaster_DataBound" OnItemDataBound="lvPurchaseSalesTransactionsMaster_ItemDataBound">
                        ...
                        <ItemTemplate>
                            <tr id="MainTableRow" valign="top" runat="server">
                                ...
                                <td>
                                    <asp:Literal ID="ltrlOpeningBalance" runat="server"></asp:Literal>
                                </td>
                            </tr>
                        </ItemTemplate>
