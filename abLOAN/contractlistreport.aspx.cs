...
namespace abLOAN
{
    public partial class contractlistreport : BasePage
    {
        ...
        protected void lvContractMaster_ItemDataBound(object sender, ListViewItemEventArgs e)
        {
            try
            {
                if (e.Item.ItemType == ListViewItemType.DataItem)
                {
                    ...
                    HyperLink ltrlCustomer = (HyperLink)e.Item.FindControl("ltrlCustomer");
                    ...
                    {
                        ltrlCustomer.NavigateUrl = objContractMasterDAL.CustomerLinks;
                        ltrlCustomer.ToolTip = objContractMasterDAL.CustomerLinks;
                    }
        ...
        private void FillContractMaster()
        {
            ...
            int TotalRecords;
            List<loanContractMasterDAL> lstContractMaster = objContractMasterDAL.SelectAllContractMasterPageWise(0, int.MaxValue, out TotalRecords, ContractDateFrom, ContractDateTo);
