                                ...
                                <div class="container row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <h4>
                                         ...
                                         <h5>  
                                             <label class="col-sm-2   control-label"><%= Resources.Resource.GuarantorName %></label>
                                        ...
                                        <h5>( 
                                            <asp:Label ID="lblContractsCount" runat="server"></asp:Label>
                                            ) عدد العقود
                                        ...
                                        <h5>( 
                                            <asp:Label ID="lblTotalRemains" runat="server"></asp:Label>
                                ...
                                <div class="card card-body">
                                    ...
                                    <div class="collapse" id='<%# "collapseExample" + Container.DataItemIndex %>'>
                                        <asp:ListView ID="lvFollowupNote" runat="server"
                                            ...
                                            OnItemCommand="lvFollowupNote_ItemCommand"
                                            ...
                                            <ItemTemplate>
                                                <tr valign="top">
                                                    ...
                                                    <td style="padding-top: 15px;">
                                                         ...
                                                         <asp:LinkButton ID="lbtnNoteDelete" runat="server"
                                                             CommandName="DeleteNoteRecord"
                                                             OnClientClick="javascript:return ConfirmDelete(this);"
                                                             CssClass="btn btn-danger btn-sm fa fa-trash"
                                                             title="Delete"></asp:LinkButton>
                                ...
                                <div class="modal-body">
                                    <div class="form-horizontal" role="form">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group">
                                                    <label class="col-sm-2 control-label"><%= Resources.Resource.Username %></label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-10">
                                                <div class="form-group">
                                                    <label class="col-sm-2   control-label"><%= Resources.Resource.CustomerName %></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <div class="text-danger">
                                                                <asp:RequiredFieldValidator ID="rfvSearchGuarantorIdNo" runat="server" ControlToValidate="txtSearchGuarantorIdNo" Display="Dynamic" SetFocusOnError="true" ValidationGroup="searchguarantordetails"><%= Resources.Messages.InputRequired %><%=Resources.Resource.GuarantorIdNo %></asp:RequiredFieldValidator>
                                                            </div>
                                                        </div>

                                                        <div class="col-sm-1">
                                                            <asp:Button ID="btnSearchGuarantorIdNo" runat="server" CssClass="btn btn-default" Text="<% $Resources:Resource, btnSearch %>" ValidationGroup="searchguarantordetails"
                                                                OnClick="btnSearchGuarantorIdNo_Click"></asp:Button>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                <div class="col-lg-6">
                                                    <label class="col-sm-4 control-label"><%= Resources.Resource.IdNo %></label>
                                                    <div class="col-sm-7">
                                                        <asp:TextBox ID="txtGuarantorIdNo" CssClass="form-control input-sm" runat="server" Enabled="false"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-7">
                                                            <asp:TextBox ID="txtGuarantorName" runat="server" CssClass="form-control input-sm" Enabled="false"></asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
