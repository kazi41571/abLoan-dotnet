<%@ Page Language="C#" MasterPageFile="Site.Master" AutoEventWireup="true" CodeBehind="contractReport.aspx.cs"
    Inherits="abLOAN.contractreport" %>
                    ...
                    <div class="row">
                        <div style="justify-content: space-between; display: flex;">
                            <div style="padding: 0 15px;">
                                <h4>
                                    <i class="fa fa-th"></i>&nbsp;<%= Resources.Resource.ContractReportFormTitle %>&nbsp;
                                    <small>
                                ...
                                <td>
                                    <table width="100%">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid; padding: 5px;" rowspan="3">
                                        ...
                                        <tr>
                                            ...
                                            <td style="border: 1px solid; padding: 5px;">
                                                <span class="text-muted"><%= Resources.Resource.ContractWriteDate %>
                                                </span>
                                            </td>
                                            <td style="border: 1px solid; padding: 5px;">
