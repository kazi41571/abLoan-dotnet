...
namespace abLOAN
{
    public partial class customer : BasePage
    {
        ...
        protected void btnDownload_Click(object sender, EventArgs e)
        {
            ...
            string[] headers = { "IsRedFlag", "Customer", "Id No", "Mobile 1", "Mobile 2", "Mobile 3", "Occupation", "Place Of Work", "City Of Residence", "District", "Address 1", "Phone 1", "Contact Person Name 1", "Address 2", "Phone 2", "Contact Person Name 2", "Links", "Verifier", "Modifier" };
            string[] columns = { "IsRedFlag", "CustomerName", "IdNo", "Mobile1", "Mobile2", "Mobile3", "Occupation", "PlaceOfWork", "CityOfResidence", "District", "Address1", "Phone1", "ContactName1", "Address2", "Phone2", "ContactName2", "Links", "VerifiedBy", "ModifiedBy" };
